...
- тип (сплошная, пунктирная), цвет и толщина ребер, способ отображения (отсутствует, круг, квадрат), цвет и размер вершин
- Программа разрешает выбирать цвет фона
- Программа сохраняет настройки между перезапусками программы

- Программа сохраняет изображения в файл в форматах bmp и jpeg
- Программа сохраняет по специальной кнопке gif-анимацию (640x480, 10fps, 5s)
